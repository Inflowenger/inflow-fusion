...
func TestBackend(t *testing.T) {
	...
	saveEntitynode := nodes.NewSvcNode("my.internal.svc.persist.*") // wildcards can be used as tables or collections
	err = svcHandler.ImplHandlerOnSubject(svcHandler.SvcTopic(saveEntitynode.Subject), func(header nats.Header, data []byte) ([]byte, error) {
